          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Total {total} teachers registered in the system
              </p>
            </div>
            <button
              onClick={() => navigate(-1)}
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span>Joined: {teacher.JoinedYear}</span>
                    </div>
                  ...
                  {/* View Button */}
                  <button className="w-full mt-4 py-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors font-medium">
                    View Details →
                  </button>
                </div>
              ))}
