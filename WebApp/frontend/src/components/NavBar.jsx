...
function NavBar({ user: propUser, handleLogout: propLogout, links }) {
  ...
  // Updated logout functionality with toast confirmation
      ...
      <div className="flex flex-col gap-4 items-center">
        ...
        <div className="flex gap-3 justify-center">
              ...
              toast.promise(
                new Promise((resolve) => {
                  setTimeout(() => {
                    ...
                    console.log("localStorage and sessionStorage cleared.This is message from NavBar.jsx");
                    resolve();
                  }, 800);
                }),
                {
          ...
          <button
            ...
            className="px-6 py-2 bg-white text-gray-700 text-sm rounded-lg hover:bg-gray-100 font-medium border border-gray-300"
          >
            Cancel
          </button>
        </div>
